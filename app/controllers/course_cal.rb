...
#       self.end_at_field   = ( options[:end_at_field]   ||= :end_date ).to_s
...
#         cur_date = event.start_date.to_date
...
#       start_at_d = start_date.to_date
#       end_at_d = end_date.to_date
...
#         if self.end_date
#           self.end_date = self.end_date.beginning_of_day + 1.day - 1.second
#         else
#           self.end_date = self.start_date + 1.day - 1.second
#         end
#       end
#     end
